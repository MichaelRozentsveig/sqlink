...
void compareStr()
{
    ...
    cin >> str2;
    String_t s2(str2);
    cout << "ANSWER: " <<s1.compareStr(s2) << endl;
}
void toLow()
{
    char str[64];
...
{
    String_t s;
    cout << s.nOfStrings() << endl;
}
void curCaseSens()
{
    String_t s;
    cout << s.getCaseSens() << endl;
}
void setCaseSens()
{
    String_t s;
...
{
    String_t s;
    cout << s.getDefCapacity() << endl;
}
void setDefCap()
{
    String_t s;
    cout <<"Current:" << s.getDefCapacity() << endl;
    cout << "Enter new default Capacity" << endl;
    int cap;
    cin >> cap;
    s.setDefCapacity(cap);
    cout <<"Current:" << s.getDefCapacity() << endl;
}
void findIndexOfChar()
{
    ...
    cin >> i;
    cout << "First occurence: "<< s1.firstOccOfChar(i) << endl << 
            "Last occurence: "<< s1.lastOccOfChar(i)<< endl; 
